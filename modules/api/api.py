...
def images_to_video_path(images):
    ...
    os.mkdir(full_dir) 
    for img in images:
        img.save(full_dir+"/frame_0"+str(count)+".png")
        count = count + \
    os.system("ffmpeg -r 1 -pattern_type glob -i "+full_dir+"/*.png -vcodec mpeg4 -y "+full_dir+"/out.mp4")
...
class Api:
    def __init__(self, app: FastAPI, queue_lock: Lock):
        ...
        self.add_api_route("/sdapi/v1/vid2vid", self.vid2vidapi, methods=["POST"], response_model=models.VideoToVideoResponse)
